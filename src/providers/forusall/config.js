...
module.exports.FIXED = {
  ...
  uploadUrlTemplate: 'https://employer.forusall.com/fv_documents_console/{planIdNumber}/manage_fv_document?add_new_document_record=true',
  selectors: {
    user: '#user_email',
    pass: '#user_password',
    loginButton: '#new_user > input.btn.btn-primary',
    otpInput: '#otp_attempt',
    otpSubmit: 'body > main > div.container > div > div > div > div.panel-body > form > div:nth-child(4) > div > div > input',
